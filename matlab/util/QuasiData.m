...
classdef QuasiData < matlab.mixin.SetGet
    ...
    methods
        ...
        function psi = nearStreamfunction(R, Th)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5555
            ...
            for k = 1:length(R)
                ...
                psi(k) = r.^-1.*b1.*cos(theta).*(r^-1 - a.^-1.*Kt1) + U.*a.*sin(theta).*Kt1 + ...
                    b2.*sin(2.*theta).*(r^-2 - a.^-2.*Kt2);
            end
        end
        function psi = farStreamfunction(R, Th)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5555
            ...
            for k = 1:length(R)
                ...
                psi(k) = b1.*r.^-1.*sin(theta) + b2.*r.^-2.*sin(2.*theta) + ...
